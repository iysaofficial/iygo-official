    ...
    return(
        ...
        <section className="low-detail-after-event-section" id="low-detail-after-event">
            <div className="low-detail-after-event-heading">
                <h1 className="section-header">After Event IYGO 2024</h1>
            </div>
            ...
            <div className="low-detail-document-container">
                ...
                <div className="serviceBox">
                    ...
                    <div className="content">
                        ...
                        <br />
                        <a href="https://drive.google.com/file/d/1JElLfMWf7-GEFW03ziyYfynPr7lf-WC9/view?usp=sharing" target="_blank" className="low-detail-document-button">Download</a>
                    </div>
                </div>
        ...
        <section className="head-low-detail-document-section" id="head-low-detail-document">
            ...
            <div className="low-press-release-button-container">
                <a href="https://drive.google.com/file/d/1NdOFy48a5igVT5h2umhzqrDZujjNRDW1/view?usp=sharing" className="low-press-release-button">Download Press Release</a>
            </div>
        </section>
        <br />
        </>
